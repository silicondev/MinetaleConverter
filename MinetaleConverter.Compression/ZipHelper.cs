...
namespace MinetaleConverter.Compression
{
    public static class ZipHelper
    {
        public static bool Decompress(string inputPath, string outputPath)
        {
            ...
            bool result = Decompress(compressedBuff, out byte[]? decompressedBuff, CompressionMethod.ZLIB);
        ...
        public static bool Decompress(byte[] input, out byte[]? output, CompressionMethod method)
        {
            switch (method)
            {
