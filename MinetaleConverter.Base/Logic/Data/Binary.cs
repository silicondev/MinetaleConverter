...
namespace MinetaleConverter.Base.Logic.Data
{
    public class Binary
    {
        ...
        public T ReadGivenLength<T, TData>(Func<TData, TData>? transform = null, int index = -1, bool seek = true) => 
            (T)Convert.ChangeType(ReadGivenLength(typeof(T), typeof(TData), transform != null ? (x) => transform((TData)x) : null, index, seek), typeof(T));
